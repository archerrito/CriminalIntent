...
public class PictureUtils {
	/*
	 * Displaying image in imageview requires handling because of its size, need ot scale image
	...
	//now add a method to clean up imageViews BitmapDrawable, if it has one.
